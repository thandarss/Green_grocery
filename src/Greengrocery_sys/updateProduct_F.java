...
public class updateProduct_F {
	...
	public void updateProduct(int id, String type, int bucketP, int vissP, int boxP) {
		...
		String sqString = "update product_price set Type=?, Bucket_Price = ?, Viss_Price = ?, Box_Price = ? where Id_Product = " + idProduct + ";";
		try {
