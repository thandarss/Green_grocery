...
public class addProduct_F {
	...
	public void addProduct(String type, int bucketP, int vissP, int boxP, String date) {
		...
		String sqString = "insert into product_price (Type, Bucket_Price, Viss_Price, Box_Price, Date) values (?, ?, ?, ?, ?);";
		try {
